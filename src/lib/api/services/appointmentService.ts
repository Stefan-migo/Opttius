...
export async function getAppointment(id: string): Promise<Appointment> {
  try {
    const response = await client.get<Appointment>(`/api/admin/appointments/${id}`);
...
export async function createAppointment(data: CreateAppointmentData): Promise<Appointment> {
  try {
    const response = await client.post<Appointment>('/api/admin/appointments', data);
    return unwrapData(response);
  } catch (error) {
...
export async function updateAppointment(
  ...
  try {
    const response = await client.put<Appointment>(`/api/admin/appointments/${id}`, data);
    return unwrapData(response);
  } catch (error) {
 ...
 */
export async function getScheduleSettings(branch_id?: string): Promise<ScheduleSettings> {
  try {
...
export async function confirmAppointment(id: string): Promise<Appointment> {
  try {
    const response = await client.post<Appointment>(`/api/admin/appointments/${id}/confirm`, {});
    return unwrapData(response);
  } catch (error) {
...
export async function cancelAppointment(id: string, reason?: string): Promise<Appointment> {
  try {
    const response = await client.post<Appointment>(`/api/admin/appointments/${id}/cancel`, { reason });
    return unwrapData(response);
  } catch (error) {
