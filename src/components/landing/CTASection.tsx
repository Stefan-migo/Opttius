      ...
      <div className="max-w-7xl mx-auto bg-epoch-primary rounded-arch overflow-hidden relative shadow-2xl">
        ...
        <div className="relative z-10 py-32 px-6 flex flex-col items-center text-center">
          ...
          <p className="text-lg md:text-xl text-white/60 max-w-2xl mx-auto font-body italic mb-12">
            Únase a la élite de profesionales ópticos que han elegido la
            excelencia técnica y la elegancia operativa. Su negocio merece el
            estándar Opttius.
          </p>
