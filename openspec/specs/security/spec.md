...
Content Security Policy (CSP) configuration for the Opttius B2B SaaS application. CSP protects against XSS attacks by controlling which scripts, styles, and other resources the browser is allowed to load and execute.
