...
| prescription   | prescriptions   | customer*id, od*_, os\__, pd, exam_date                            |
| lab_work_order | lab_work_orders | customer*id, prescription_id, frame*_, lens\__, field_operation_id |
