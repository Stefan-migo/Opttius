...
- [x] Webhooks para eventos de suscripción (Stripe/pasarela) — 2026-04 (ya existentes, documentados)
- [x] Auditoría de acciones root (quién hizo qué, cuándo) — 2026-04
- [x] Rate limiting en endpoints sensibles — 2026-04 (ya implementado)
- [x] Documentación de Webhooks — 2026-04

**Nota:** Ver `SAAS_MANAGEMENT_ROADMAP.md` para el detalle del roadmap de implementación.
