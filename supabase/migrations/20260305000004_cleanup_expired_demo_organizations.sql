-- Migration: cleanup_expired_demo_organizations
-- Deletes demo orgs (metadata->>'is_demo' = 'true') whose expires_at has passed.
-- Excludes the global demo org (00000000-0000-0000-0000-000000000001).
