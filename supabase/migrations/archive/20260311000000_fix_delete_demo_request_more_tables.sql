-- Migration: 20260311000000_fix_delete_demo_request_more_tables.sql
...
-- Fix: Add more table deletes and conditional internal_orders for delete_demo_request_and_org
-- Covers: billing, telemetry, tier_change_audit, ai_usage_log, whatsapp, user_tour_progress, system_config
-- Wraps internal_orders in EXISTS check for robustness
