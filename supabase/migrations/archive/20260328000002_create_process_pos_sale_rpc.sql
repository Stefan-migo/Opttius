-- Migration: 20260328000002_create_process_pos_sale_rpc.sql
...
-- Migration: Create process_pos_sale RPC for transactional POS sales
-- Ensures atomicity: order + order_items + order_payments + stock reduction + lab_work_order + pos_transactions
...
BEGIN
  ...
  -- 4. Stock reduction (skip services and temp IDs)
