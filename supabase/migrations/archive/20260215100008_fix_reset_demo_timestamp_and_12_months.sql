-- Migration: 20260215100008_fix_reset_demo_timestamp_and_12_months.sql
...
-- Migration: Fix timestamp-integer operator error and set demo to 12 months
-- Error: "operator does not exist: timestamp with time zone - integer"
-- Cause: NOW() - (random()*N)::INT invalid; must use NOW() - ((random()*N)::INT * INTERVAL '1 day')
-- Also: Set days_back to 365 for 12 months of mockup data
