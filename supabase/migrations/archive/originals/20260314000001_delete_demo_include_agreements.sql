-- Migration: 20260314000001_delete_demo_include_agreements.sql
...
-- Migration: Include agreements tables in delete_demo_request_and_org
-- Ensures agreements, purchase orders, and institutional balances are deleted when demo org is removed
...
COMMENT ON FUNCTION public.delete_demo_request_and_org(UUID) IS 'Deletes a demo request and its associated demo organization. Root only. Includes agreements tables.';
