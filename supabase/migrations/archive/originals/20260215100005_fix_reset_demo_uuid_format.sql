-- Migration: 20260215100005_fix_reset_demo_uuid_format.sql
...
-- Migration: Fix invalid UUID format in reset_demo_organization customer inserts
-- Fixes: invalid input syntax for type uuid: "10000000-0000-0000-0000-0000000000000006"
-- The prefix had an extra "0000" making the last segment 16 chars instead of 12.
-- Correct format: '10000000-0000-0000-0000-' || LPAD(n, 12, '0') = 8-4-4-4-12
