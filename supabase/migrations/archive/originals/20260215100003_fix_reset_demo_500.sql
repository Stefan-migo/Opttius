-- Migration: 20260215100003_fix_reset_demo_500.sql
...
-- Migration: Fix reset-demo 500 error in production
-- 1. Add statement_timeout (2 min) to avoid Supabase default 8s timeout
-- 2. Only insert optical_internal_support_tickets when demo admin in admin_users (FK)
-- 3. Reduce cash/pos loop from 630 to 180 days to avoid timeout
