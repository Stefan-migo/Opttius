-- Migration: 20260305000002_create_demo_org_for_user.sql
...
-- Migration: create_demo_organization_for_user
-- Creates a dedicated demo org (7 days) for a user, cloning Mirada Clara structure.
-- demo_type: 'known_optica' (banner visible) | 'organic' (banner hidden)
...
COMMENT ON FUNCTION public.create_demo_organization_for_user(UUID, TEXT) IS 'Creates a dedicated 7-day demo org for a user. demo_type: known_optica (banner on) | organic (banner off).';
