-- Migration: 20260225000000_reset_demo_use_mirada_clara.sql
...
-- Migration: Switch reset_demo_organization to use Óptica Mirada Clara
-- Creates seed_demo_mirada_clara() and updates reset_demo_organization() to call it
-- instead of seed_demo_organization_data() (Óptica Demo Global).
--
-- Org: 00000000-0000-0000-0000-000000000001
-- Branch 1: 00000000-0000-0000-0000-000000000002 (MCL-001 Casa Matriz)
-- Branch 2: 00000000-0000-0000-0000-000000000003 (MCL-002 Sucursal Providencia)

-- ===== 1. Create seed_demo_mirada_clara() =====
...
COMMENT ON FUNCTION public.seed_demo_mirada_clara() IS 'Seeds Demo Óptica Mirada Clara: org, 2 branches, 6 months progressive data. Used by reset_demo_organization().';

-- ===== 2. Update reset_demo_organization to use seed_demo_mirada_clara =====
...
COMMENT ON FUNCTION public.reset_demo_organization() IS 'Resets Demo Óptica Mirada Clara (org 00000000-0000-0000-0000-000000000001) to initial state. Deletes all demo data and re-seeds with 6 months progressive data via seed_demo_mirada_clara().';
