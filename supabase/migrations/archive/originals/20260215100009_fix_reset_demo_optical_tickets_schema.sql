-- Migration: 20260215100009_fix_reset_demo_optical_tickets_schema.sql
...
-- Migration: Fix optical_internal_support_tickets insert - use correct column names
-- Error: column "created_by" does not exist
-- Schema uses: created_by_user_id, description (NOT NULL), category (NOT NULL)
-- Replaces seed_demo_organization_data() when 008 was applied with wrong schema.
