-- Migration: 20260301000003_demo_providencia_real_names.sql
...
-- Migration: Add real names to Providencia branch 2 demo customers (6-18)
-- Replaces ClienteProv6, ClienteProv7, etc. with real Chilean names.
...
COMMENT ON FUNCTION public.seed_demo_mirada_clara() IS 'Seeds Demo Óptica Mirada Clara. Casa Matriz + Providencia: all customers with real Chilean names.';
