-- Migration: 20260306000000_fix_create_demo_org_ensure_categories.sql
...
-- Migration: Ensure default categories exist before create_demo_organization_for_user
-- Fixes "Categories not found" error when approving demo requests

-- Ensure the 4 required categories exist (idempotent)
...
-- Update create_demo_organization_for_user to ensure categories exist at runtime
...
BEGIN
  ...
  VALUES
    (v_branch_1_id, 'Casa Matriz', 'DEMO-001', v_org_id, 'Av. Providencia 1234', 'Santiago', 'Región Metropolitana', '7500000', 'Chile', '+56 2 2345 6789', 'demo@optica.cl', true, NOW()),
    (v_branch_2_id, 'Sucursal Providencia', 'DEMO-002', v_org_id, 'Av. Apoquindo 4567', 'Las Condes', 'Región Metropolitana', '7550000', 'Chile', '+56 2 2345 6790', 'providencia@optica.cl', true, NOW());
  ...
  VALUES
    (gen_random_uuid(), v_branch_1_id, v_org_id, 'Marco Ray-Ban RB2140', 'marco-ray-ban-rb2140', 'Marco clásico aviador Ray-Ban.', 89900, 45000, v_marcos_cat_id, 'RB-2140-BLK', 'active', true, true, 'https://images.unsplash.com/photo-1511499767150-a48a237f0083?w=400', NOW()),
    (gen_random_uuid(), v_branch_1_id, v_org_id, 'Marco Oakley OO9208', 'marco-oakley-oo9208', 'Marco deportivo Oakley.', 129900, 65000, v_marcos_cat_id, 'OO-9208-BLK', 'active', true, true, 'https://images.unsplash.com/photo-1511499767150-a48a237f0083?w=400', NOW()),
    (gen_random_uuid(), v_branch_1_id, v_org_id, 'Gafas de Sol Ray-Ban Aviator', 'gafas-sol-ray-ban', 'Gafas de sol Ray-Ban Aviator.', 119900, 60000, v_lentes_sol_cat_id, 'RB-AVI-SUN', 'active', true, true, 'https://images.unsplash.com/photo-1511499767150-a48a237f0083?w=400', NOW()),
    (gen_random_uuid(), v_branch_1_id, v_org_id, 'Estuche Rígido Premium', 'estuche-rigido', 'Estuche rígido para lentes.', 12900, 5000, v_accesorios_cat_id, 'ACC-EST-RIG', 'active', true, true, NULL, NOW()),
