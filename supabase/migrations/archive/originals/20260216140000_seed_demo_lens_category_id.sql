-- Migration: 20260216140000_seed_demo_lens_category_id.sql
...
-- Migration: Add category_id to lens/contact lens families in seed_demo_organization_data.
-- Runs after add_category_to_lens_families and add_lens_categories.
...
BEGIN
  ...
  SELECT id INTO mono_cat_id FROM public.categories WHERE slug = 'monofocales' LIMIT 1;
  SELECT id INTO prog_cat_id FROM public.categories WHERE slug = 'progresivos' LIMIT 1;
  SELECT id INTO bifocal_cat_id FROM public.categories WHERE slug = 'bifocales' LIMIT 1;
  ...
  -- ===== 1. LENS FAMILIES (with category_id) =====
  ...
  VALUES
  ('40000000-0000-0000-0000-000000000001'::uuid, 'Monofocal Básico CR-39 AR', 'Genérico', 'single_vision', 'cr39', 'Lente monofocal estándar con antirreflejo básico.', true, demo_org_id, mono_cat_id, NOW()),
  ('40000000-0000-0000-0000-000000000002'::uuid, 'Monofocal Policarbonato Blue Cut', 'Essilor', 'single_vision', 'polycarbonate', 'Monofocal resistente con filtro de luz azul.', true, demo_org_id, mono_cat_id, NOW()),
  ('40000000-0000-0000-0000-000000000003'::uuid, 'Monofocal Alto Índice 1.67 AR Premium', 'Hoya', 'single_vision', 'high_index_1_67', 'Lente delgado para graduaciones medias-altas.', true, demo_org_id, mono_cat_id, NOW()),
  ('40000000-0000-0000-0000-000000000004'::uuid, 'Monofocal Alto Índice 1.74 AR Ultra Delgado', 'Zeiss', 'single_vision', 'high_index_1_74', 'Lente ultra delgado para graduaciones muy altas.', true, demo_org_id, mono_cat_id, NOW()),
  ('40000000-0000-0000-0000-000000000005'::uuid, 'Monofocal Antifatiga Digital', 'Rodenstock', 'single_vision', 'cr39', 'Lente de confort para pantallas.', true, demo_org_id, mono_cat_id, NOW()),
  ('40000000-0000-0000-0000-000000000006'::uuid, 'Monofocal Fotocromático CR-39', 'Transitions', 'single_vision', 'cr39', 'Lente que se oscurece con luz UV.', true, demo_org_id, mono_cat_id, NOW()),
  ('40000000-0000-0000-0000-000000000007'::uuid, 'Bifocal Flat Top 28mm CR-39', 'Genérico', 'bifocal', 'cr39', 'Bifocal económico y funcional.', true, demo_org_id, bifocal_cat_id, NOW()),
  ('40000000-0000-0000-0000-000000000008'::uuid, 'Bifocal Invisilens Policarbonato', 'Essilor', 'bifocal', 'polycarbonate', 'Bifocal de policarbonato resistente.', true, demo_org_id, bifocal_cat_id, NOW()),
  ('40000000-0000-0000-0000-000000000009'::uuid, 'Progresivo Básico CR-39 FreeForm', 'Genérico', 'progressive', 'cr39', 'Progresivo de entrada FreeForm.', true, demo_org_id, prog_cat_id, NOW()),
  ('40000000-0000-0000-0000-000000000010'::uuid, 'Progresivo Comfort Policarbonato', 'Essilor', 'progressive', 'polycarbonate', 'Progresivo Varilux Comfort.', true, demo_org_id, prog_cat_id, NOW()),
  ('40000000-0000-0000-0000-000000000011'::uuid, 'Progresivo Individualizado Alto Índice 1.67', 'Zeiss', 'progressive', 'high_index_1_67', 'Progresivo Zeiss Individual 2.', true, demo_org_id, prog_cat_id, NOW()),
  ('40000000-0000-0000-0000-000000000012'::uuid, 'Progresivo para Conducción 1.74', 'Hoya', 'progressive', 'high_index_1_74', 'Progresivo optimizado para conducción.', true, demo_org_id, prog_cat_id, NOW()),
  ('40000000-0000-0000-0000-000000000013'::uuid, 'Progresivo Digital Blue Defense', 'Genérico', 'progressive', 'polycarbonate', 'Progresivo con filtro azul.', true, demo_org_id, prog_cat_id, NOW()),
  ...
  ('40000000-0000-0000-0000-000000000016'::uuid, 'Monofocal Polarizado Gris Policarbonato', 'Genérico', 'single_vision', 'polycarbonate', 'Monofocal polarizado para sol.', true, demo_org_id, mono_cat_id, NOW()),
  ('40000000-0000-0000-0000-000000000017'::uuid, 'Progresivo Espejado Azul 1.67', 'Essilor', 'progressive', 'high_index_1_67', 'Progresivo espejado para sol.', true, demo_org_id, prog_cat_id, NOW()),
  ...
  -- ===== 3b. Backfill category_id for existing demo families =====
  UPDATE public.lens_families SET category_id = mono_cat_id WHERE organization_id = demo_org_id AND category_id IS NULL AND lens_type IN ('single_vision');
  UPDATE public.lens_families SET category_id = prog_cat_id WHERE organization_id = demo_org_id AND category_id IS NULL AND lens_type = 'progressive';
  UPDATE public.lens_families SET category_id = bifocal_cat_id WHERE organization_id = demo_org_id AND category_id IS NULL AND lens_type = 'bifocal';
  ...
  IF marcos_cat_id IS NOT NULL AND lentes_sol_cat_id IS NOT NULL AND accesorios_cat_id IS NOT NULL AND servicios_cat_id IS NOT NULL THEN
    ...
    ('20000000-0000-0000-0000-000000000012'::uuid, demo_branch_id, demo_org_id, 'Gafas de Sol Oakley Holbrook', 'gafas-sol-oakley-holbrook', 'Gafas Oakley polarizadas.', 149900, 75000, lentes_sol_cat_id, 'OO-HOL-SUN', 'active', true, true, 'https://images.unsplash.com/photo-1511499767150-a48a237f0083?w=400', NOW())
