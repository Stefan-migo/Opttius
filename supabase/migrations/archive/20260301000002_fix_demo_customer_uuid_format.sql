-- Migration: 20260301000002_fix_demo_customer_uuid_format.sql
...
-- Migration: Fix invalid UUID format in seed_demo_mirada_clara customer IDs
-- The generate_series produced '10000000-0000-0000-000000000011' (missing 4th segment).
-- Valid UUID format is 8-4-4-4-12. Fix: use '10000000-0000-0000-0000-' prefix (add 0000-).
...
BEGIN
  ...
  -- ===== CUSTOMERS branch 1 (UUID format 8-4-4-4-12: use '10000000-0000-0000-0000-' prefix) =====
  ...
  -- ===== CUSTOMERS branch 2 (UUID format 8-4-4-4-12: use '11000000-0000-0000-0000-' prefix) =====
  INSERT INTO public.customers (id, branch_id, organization_id, first_name, last_name, email, phone, rut, date_of_birth, gender, address_line_1, city, state, postal_code, country, medical_conditions, allergies, last_eye_exam_date, next_eye_exam_due, preferred_contact_method, insurance_provider, is_active, created_at, updated_at)
  VALUES
...
COMMENT ON FUNCTION public.seed_demo_mirada_clara() IS 'Seeds Demo Óptica Mirada Clara. Customer UUIDs use valid 8-4-4-4-12 format.';
